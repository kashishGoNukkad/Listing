  ...
  const passwordRequirements = [
    {
      ...
      meets: formData.password.length >= 8,
    },
    { id: 2, text: "Contains a number", meets: /\d/.test(formData.password) },
    {
      id: 3,
      text: "Contains a special character",
      meets: /[!@#$%^&*(),.?":{}|<>]/.test(formData.password),
    },
    {
      id: 4,
      text: "Contains uppercase letter",
      meets: /[A-Z]/.test(formData.password),
    },
  ];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className=" w-full bg-white rounded-2xl shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-2">
        {/* Left Illustration */}
        <div className="hidden md:flex items-center justify-center bg-gradient-to-br from-blue-100 to-indigo-200 p-8">
          <img
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          ...
          {!isSubmitted ? (
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={formData.password}
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition-all duration-200 outline-none pr-10"
                      placeholder="Enter your new password"
                      required
                    />
                    <button
                        ...
                        <li key={req.id} className="flex items-center">
                          <div
                            className={`h-3 w-3 rounded-full mr-2 ${
                              req.meets ? "bg-green-500" : "bg-gray-300"
                            }`}
                          ></div>
                          <span
                            className={`text-xs ${
            ...
            <div className="text-center">
              ...
              <a
                href="/login"
                className="inline-block py-3 px-6 bg-gradient-to-r from-indigo-500 to-blue-500 text-white font-semibold rounded-lg shadow-md hover:from-indigo-600 hover:to-blue-600 transition-all duration-300"
              >
                Continue to Login
              </a>
            </div>
